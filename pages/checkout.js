    ...
    <div className='container px-2 sm:m-auto'>
      ...
      <div className='px-2 w-full'>
        <div className="mb-4">
          ...
          <textarea rows="2" cols="30" id="address" name="address" className="w-full bg-white rounded border border-gray-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"></textarea>
