...
const Slug = ({addToCart}) => {
  ...
  const checkServiceability = async()=>{
    ...
    if(pinJson.includes(parseFloat(pin))){
      setService(true);
    }
    else{
      setService(false);
    ...
    <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/71RYmFd2sPL._AC_UX425_.jpg" />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 className="text-sm title-font text-gray-500 tracking-widest">Geek-Garage</h2>
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Geek Wear (XL/Blue)</h1>
              ...
              <div className="flex">
                ...
                <button onClick={()=>{addToCart(slug, 1, 499, 'Geek wear (XL/Red)', 'XL', 'Red')}} className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
              ...
              {(service && service != null) && <div className="text-green-700 text-sm mt-3">
               Yaay!, We will deliver to this pincode
              </div>}
